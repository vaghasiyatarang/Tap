...
const UsePage = () => {
  ...
  return (
    <section className="bg-gray-100 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <Link
        prefetch={false}
        href={`/api/vcard?first=Vagaro%20Technologi&last=Technologi&company=Vagaro&title=React%20Developer&phone=1234567890&email=vagaro@yopmail.com&city=Ahmedabad&region=Gujarat&country=India`}
        className="rounded-lg px-4 py-2 bg-black text-white inline-block"
      >
        Save Contact
      </Link>
    </section>
